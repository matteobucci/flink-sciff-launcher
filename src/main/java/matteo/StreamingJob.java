...
public class StreamingJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //TODO: UTILIZZARE UN FILE PER PRENDERE I FILE DEL MODELLO.
        ...
        try {
            ...
            if (cmd.hasOption(outputOption.getOpt())) {
                printToConsole = true;
                if (o) System.out.println("Print to console forced");
            }
            ...
            if (cmd.hasOption(fileOption.getOpt())) {
                ...
                if (o) System.out.println("Results are going to be in " + file.getPath());
            }
            ...
            sciffCmd = new String[]{
                    ...
                    "working_directory(_,'" +
                            ...
                            SubmodelVariables.model +
                            "," + SubmodelVariables.observability +
                            "," + SubmodelVariables.durationConstr +
                            "," + SubmodelVariables.interTaskConstr + "," +
                            SubmodelVariables.options + ")",
                    "-t",
                    "halt",
        ...
        env.getConfig().setLatencyTrackingInterval(1000); //TODO: This should work but it doesn't

        DataStream<String> data = env.socketTextStream(host, port);

		/* Stream flow */

        SingleOutputStreamOperator<Tuple2<String, String>> output = data
                .filter(new NotEmptyFilter()).setParallelism(1)                                                       //Remove empty lines
                .flatMap(new EventSplitter())    .setParallelism(1)                                                   //Extract single elements
                .map(new EventExtractor()) .setParallelism(1)                                                         //Map key and event
